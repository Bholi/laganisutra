...
from floorsheet.models import FloorSheetData, SellerActivityReport


class Command(BaseCommand):
    help = 'Aggregate FloorSheetData and store results in Seller Activity Report'
    ...
    def handle(self, *args, **kwargs):
        ...
        if latest_date:
            ...
            Seller_data = cleaned_data.values('seller', 'symbol').annotate(
                total_quantity_sold=Sum('clean_quantity'),
            ...
            # Store the calculated data in the SellerActivityReport model
            for data in Seller_data:
                SellerActivityReport.objects.create(
                    seller_id=data['seller'],
                    symbol=data['symbol'],
                    total_quantity_sold=data['total_quantity_sold'],
                    total_amount_received=data['total_amount_spent'],
            ...
            print("Seller activity report has been calculated and stored.")
        else:
